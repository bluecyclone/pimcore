...
class ObjectMetadata extends Model\AbstractModel implements DataObject\OwnerAwareFieldInterface
{
     ...
     * @return mixed
     */
    public function load(DataObject\Concrete $source, $destination, $fieldname, $ownertype, $ownername, $position, $index)
    {
        return $this->getDao()->load($source, $destination, $fieldname, $ownertype, $ownername, $position, $index);
    }
